...
// User-specific Blog Routes (requires authentication) - Define BEFORE public routes
Route::middleware($userMiddleware)
    ->prefix($prefix)
    ->name($namePrefix)
    ->group(function () {
        // User blog management - specific routes first
...
Route::middleware($publicMiddleware)
    ...
    ->group(function () {
        ...
        // Single post view - MUST be last (catch-all)
